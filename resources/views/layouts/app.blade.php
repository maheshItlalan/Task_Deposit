...
<head>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/alpinejs/2.8.2/alpine.js" integrity="sha512-Vl1Wf+cPDrs5O7xw4X5jtFfA1F0EnJH3EkMv5dOfANcfX6ggMg4iYYtWBwb9ZAN6O6UohzFj2M+sF0xQhaAbDg==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-icons/1.3.0/font/bootstrap-icons.min.css" integrity="sha512-LP7m4Q6BBE6DJf0JKj+duHnDSv9bEal6+bL3TpQ2wGFXnexjjxwHJH44MW53o4ByQFBAou1RHk5z1g/BVdS3g==" crossorigin="anonymous" referrerpolicy="no-referrer" />
</head>
        ...
        <div class="flex justify-between">
            ...
            <div class="flex items-center">
                ...
                <div x-data="{ open: false }" class="relative inline-block text-left">
                    <button class="flex items-center px-3 py-2 focus:outline-none hover:bg-gray-200 hover:rounded-md" type="button" @click="open = !open" :class="{ 'bg-gray-200 rounded-md': open }">
                        <img src="https://aaah0mnbncqtinas.public.blob.vercel-storage.com/SO6brs3ihC-no-background-HOdNeF8bCw1y9s5Xtnpv0hFAC6IaeJ.png" alt="Profile" class="h-8 w-8 rounded-full">

                        <span class="ml-4 text-sm hidden md:inline-block">Mahesh</span>
                    ...
                    <div x-show="open" @click.away="open = false" class="text-sm text-left absolute top-0 right-0 mt-16 mr-4 bg-white rounded border border-gray-400 shadow" style="display: none;">
                        <ul>
                            ...
                            <li class="px-4 py-3 hover:bg-gray-200"><a href="#">Log out</a></li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="flex flex-row">
        <div class="flex flex-col w-64 h-screen overflow-y-auto bg-gray-900 border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
            <div class="sidebar text-center bg-gray-900">
                ...
                <a href="{{ route('depositFail.failed') }}">
                    <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
                        <i class="bi bi-x-circle-fill"></i>
                        <span class="text-[15px] ml-4 text-gray-200 font-bold">Failed Deposits</span>
                    </div>
                </a>
                <a href="{{ route('import') }}">
                    <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
                        <i class="bi bi-x-circle-fill"></i>
                        <span class="text-[15px] ml-4 text-gray-200 font-bold">Import File</span>
                    </div>
                </a>
                <a href="{{route('logout')}}">
